...
const Publish = () => (
    <Layout>
        ...
        <div className={styles.row}>
            <li>
                Rojas, L.A., Valentine, E., Accorsi, A., Maglio, J., Shen, N., Robertson, A., Kazmirski, S., Rahl, P., Tawil, R., Cadavid, D., Thompson, L.A., Ronco, L., Chang, A., Cacace, A., and Wallace, O., 2020. P38α Regulates Expression of DUX4 in Facioscapulohumeral Muscular Dystrophy. Journal of Pharmacology and Experimental Therapeutics. 119.264689
            </li>
        </div>
        <div className={styles.row}>
            <li>
        ...
        <div className={styles.row}>
            <li>
                Sparks, E.E., Drapek, C.E., Gaudinier, A., Li, S., Ansariola, M., Shen, N., Matsumoto, N., Turco, G., Qiu, Y., Petricka, J.J., Foret, J., Chen, M., Gordân, R., Megraw, M. and Brady, S., Benfey, P.N., 2016. Establishment of expression in the SHORTROOT-SCARECROW transcriptional cascade through opposing activities of both activators and repressors. Developmental Cell 39(5):585-596
            </li>
        </div>
        <div className={styles.row}>
            <li>
                Zhou, T.*, Shen, N.*, Yang, L., Horton, J., Bussemaker, H., Gordân, R.+ and Rohs, R+., 2015. Quantitative modeling of transcription factor binding specificities using DNA shape. Proceedings of the National Academy of Science 112(15); 4654-4659
            </li>
        </div>
        <div className={styles.row}>
            <li>
                Gordân, R., Shen, N., Dror, I., Zhou, T., Horton, J., Rohs, R. and Bulky, M.L., 2013. Genomic regions flanking E-box binding sites influence DNA binding specificity of bHLH transcription factors through DNA shape. Cell Reports 3(4):1093-104
            </li>
        </div>
        <div className={styles.row}>
            <li>
