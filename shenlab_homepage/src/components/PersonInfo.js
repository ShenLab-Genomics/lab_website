...
export function PersonInfoSmall({ props, hidePhoto }) {
  return (
    <Card
      className={style.photodiv_small}
      sx={{ backgroundColor: "#d5d5d520" }}
    >
      ...
      <CardContent sx={{ display: "flex", alignItems: "center" }}>
        <Grid container direction="row" spacing={0}>
          <Grid className={style.img_grid} item xs={8}>
            {props.photo && <img className={style.photo} src={props.photo} />}
          </Grid>
          {/* <Grid item xs={4}> */}
            ...
            <Grid item>
              ...
              {props.interest ? (
                <Typography variant="p">
                  Research interest: {props.interest}
                </Typography>
              ) : null}
            </Grid>
          </Grid>
